...
export default function WashingtonEVCaseStudy() {
  return <main className="case-page" id="top">
    <header className="site-header"><div className="shell nav"><a className="brand" href="/"><span>DE</span><div><b>David Edmonds</b><small>DATA ANALYTICS &amp; BI</small></div></a><nav aria-label="Case study navigation"><a href="/#work">Portfolio</a><a href="/#skills">Skills</a><a href="/#experience">Experience</a></nav><a className="header-cta" href="mailto:davidedmondsc@gmail.com?subject=Analytics%20project%20inquiry">Let’s talk <span>↗</span></a></div></header>
    ...
    <footer className="footer shell"><a className="brand" href="/"><span>DE</span><div><b>David Edmonds</b><small>DATA ANALYTICS &amp; BI</small></div></a><p>Washington EV Market Overview<br/>Tableau case study</p><div><a href="/#work">Portfolio</a><a href="https://www.linkedin.com/in/david-c-edmonds/">LinkedIn</a><a href="#top">Top ↑</a></div><small>© {new Date().getFullYear()} David Edmonds · Public data portfolio project.</small></footer>
  </main>
}
