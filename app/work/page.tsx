...
const projects = [
  ...
  { id: "sales", tool: "Excel", title: "Sales & Profitability", type: "EXCEL · INDEPENDENT PORTFOLIO EXAMPLE", image: "/sales-profitability/dashboard.png", alt: "Excel sales and profitability dashboard", summary: "See what drives revenue growth and changing margins.", href: "/work/sales-profitability", download: "/sales-profitability/sales-profitability-package.zip", note: "Fictional data" },
  { id: "sql", tool: "SQL", title: "Sales Growth, Profit Pressure", type: "SQL · INDEPENDENT PORTFOLIO EXAMPLE", summary: "Five SQL investigations trace performance back to source records.", href: "/work/sql-sales-investigation", download: "/sql-sales/sql-sales-project.zip", note: "Fictional data" },
  { id: "federal", tool: "Power BI", title: "Federal Contracting Performance", type: "POWER BI PUBLIC-DATA CASE STUDY", image: "/federal-contracting-dashboard.jpg", alt: "Power BI federal contracting dashboard", summary: "Explore federal awards, agency activity and small-business participation.", href: "/work/federal-contracting-performance", note: "Public data · PBIX and source files are not published." },
  { id: "ev", tool: "Tableau", title: "Washington EV Market Overview", type: "TABLEAU CASE STUDY", image: "/washington-ev-dashboard.png", alt: "Washington electric vehicle market dashboard", summary: "Compare the registered EV fleet across counties and manufacturers.", href: "/work/washington-ev-market", note: "Public registration data" },
  { id: "planner", tool: "Interactive", title: "Profit Scenario Planner", type: "INTERACTIVE · INDEPENDENT PORTFOLIO EXAMPLE", summary: "Test how price, volume and costs change operating profit.", href: "/work/profit-scenario-planner", note: "Fictional data · inputs stay in your browser" },
];
  ...
  return <main id="top" className="work-overview">
    ...
    <section className="shell work-overview-projects" aria-label="Portfolio projects"><div className="work-card-grid">
      {projects.map((project, index) => <article className="work-card" id={project.id} key={project.id}>
        ...
        <div className="work-card-copy"><span className="work-card-tool" title={project.type}>{project.tool}</span><h2><a href={project.href}>{project.title}</a></h2><p>{project.summary}</p><div className="work-card-actions"><a className="work-card-primary" href={project.href}>View project <span aria-hidden="true">↗</span></a>{project.download ? <a href={project.download} download>Download</a> : project.id === "planner" ? <a href="/tools/profit-planner">Try the planner</a> : project.id === "ev" ? <a href="https://public.tableau.com/app/profile/david.edmonds5066/viz/WashingtonEVMarketOverview/Dashboard1#1" target="_blank" rel="noreferrer">Open Tableau</a> : null}</div><small className="work-card-note">{project.note}</small></div>
      </article>)}
    </div></section>
