...
export default function ExecutiveBrief() {
  return <main id="top">
    ...
    <section className="brief-sheet shell" aria-labelledby="brief-title">
      ...
      <div className="case-page-actions"><a className="secondary-action" href="/sql-sales/results/01_performance.csv">Annual results ↓</a><a className="secondary-action" href="/sql-sales/results/03_profit_drivers.csv">Profit contributions ↓</a><a className="secondary-action" href="/sql-sales/results/05_regional_plan.csv">Regional plan results ↓</a></div>
    </section>
    ...
    <SalesJourney />
    <ProjectContact source="brief" topic="health-check" title="Need a decision-ready readout?" description="Discuss a concise brief backed by a validated dashboard, clear definitions and an agreed next question." />
  </main>;
}
