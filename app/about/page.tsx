...
const title = "About David Edmonds | Data Analytics & BI Consultant";
const description = "David Edmonds brings more than a decade of experience in dashboards, operational reporting, data quality, defense, intelligence, recruiting, and business operations.";
...
export default function AboutPage() {
  return <main id="top">
    <section className="page-intro shell about-intro"><span>ABOUT DAVID</span><h1>A career built around<br/><em>decision support.</em></h1><p>I bring more than a decade of experience in operational reporting, dashboard development, data quality, large-scale analysis, defense, intelligence, recruiting, and business operations.</p><a className="button dark" href="/david-edmonds-resume.pdf" download>Download resume <span>↓</span></a></section>
