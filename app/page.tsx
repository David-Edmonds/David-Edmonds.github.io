...
export default function Home() {
  return <main id="top">
    <section className="hero shell">
      <div className="hero-text"><div className="status"><i/> PORTFOLIO · OPEN TO REMOTE ANALYTICS ROLES</div><h1>Complex data.<br/><em>Clear direction.</em></h1><p>I’m David, a senior data analyst and BI professional currently working as a Data Analytics Consultant with Confia Solutions, LLC. I build dashboards, reporting systems, and analysis that help teams see what matters and decide what to do next.</p><div className="hero-actions"><a className="button blue" href="/work">See my work <span>→</span></a><a className="underlink" href="/contact">Contact David ↗</a></div></div>
    ...
    <section className="section shell home-section"><SectionTitle eyebrow="01 · CAPABILITIES" title="The capabilities behind" accent="the work." />
      ...
      <a className="section-link" href="/work">Explore the portfolio <span>→</span></a>
    </section>
    ...
    <section className="contact compact-contact"><div className="shell contact-grid"><div><span>CAREER &amp; CONSULTING</span><h2>Let’s find the right <em>next step.</em></h2></div><div><p>Contact me about remote analytics roles or questions about my work. For consulting services and project inquiries, visit Bold Proof Analytics.</p><a className="button dark" href="/contact">Contact David <span>↗</span></a><p><a className="underlink" href="https://bold-proof-analytics.pages.dev/">Explore Bold Proof Analytics ↗</a></p></div></div></section>
  </main>;
}
