...
const topics: Record<string,string>={"health-check":"Reporting Health Check",dashboards:"Dashboard Build",reporting:"Reporting Automation",kpis:"KPI definition & review",analysis:"Sales or performance investigation",general:"Help me choose a service"};
const sources: Record<string,string>={sales:"Sales & Profitability",sql:"SQL Sales Investigation",federal:"Federal Contracting Performance",ev:"Washington EV Market Overview","profit-planner":"Profit Scenario Planner",brief:"Executive Brief"};
...
export default function InquiryDraft(){
 ...
 return <section className="inquiry shell" id="inquiry" aria-labelledby="inquiry-title"><div><span>CONSULTING · BOLD PROOF ANALYTICS</span><h2 id="inquiry-title">Bring your problem.<br/>Let’s clarify the next step.</h2><p>A short description is enough to start. We can then discuss the data, audience, deliverables and scope before agreeing on the work.</p><ul><li>The decision or recurring report you need to improve.</li><li>Your current tools and the people who use the output.</li><li>Any timing or scope constraints.</li></ul><p>Leave out confidential data, personal records and credentials. A high-level description is enough.</p></div>
